...
class Waitlist(Base):
    ...
    __table_args__ = (UniqueConstraint("email", "source", name="uq_waitlist_email_source"),)
    ...
    source: Mapped[str] = mapped_column(Text, nullable=False, server_default=text("'pricing'"))
    meta: Mapped[dict[str, Any]] = mapped_column(JSON, nullable=False, server_default=text("'{}'"))
