...
_SEEDED_MERCHANTS: list[tuple[str, str, str, str, list[str], str | None]] = [
    (
        ...
        "Starbucks",
        "fnb",
        ["Starbucks TH", "STARBUCKS COFFEE", "สตาร์บัคส์"],
        "dining-restaurants",
    ),
    (
        "grab-food",
    ...
    (
        ...
        "Lazada",
        "ecommerce",
        ["Lazada TH", "lazada.co.th", "ลาซาด้า"],
        "shopping",
    ),
    (
        "seven-eleven",
        ...
        "7-Eleven",
        "retail",
        ["7-11", "เซเว่น", "7 Eleven", "CPALL"],
        "grocery",
    ),
    (
        "central-department-store",
        "เซ็นทรัล ห้างสรรพสินค้า",
        "Central Department Store",
        "retail",
        ["Central", "Central Dept Store", "เซ็นทรัล"],
        "shopping",
    ),
    (
        "central-restaurants-group",
        "เซ็นทรัล เรสเตอรองส์ กรุ๊ป",
        "Central Restaurants Group",
        "fnb",
        ["CRG", "Central Restaurants"],
        "dining-restaurants",
    ),
    (
        "siam-paragon",
    ...
    (
        ...
        "Foodpanda",
        "fnb",
        ["Food Panda", "foodpanda TH", "ฟู้ดแพนด้า"],
        "dining-restaurants",
    ),
    ...
    (
        ...
        "Tops Supermarket",
        "retail",
        ["Tops", "Tops Market", "ท็อปส์ ซูเปอร์มาร์เก็ต"],
        "grocery",
    ),
    ...
    (
        ...
        "Lotus's",
        "retail",
        ["Tesco Lotus", "Lotus", "โลตัส", "เทสโก้โลตัส"],
        "grocery",
    ),
    (
        "cp-fresh-mart",
    ...
    (
        ...
        "Emporium / EmQuartier",
        "retail",
        ["Emporium", "EmQuartier", "เอ็มโพเรียม", "เอ็มควอเทียร์"],
        "shopping",
    ),
    ...
    (
        ...
        "Cafe Amazon",
        "fnb",
        ["Amazon Cafe", "Cafe Amazon", "คาเฟ่อเมซอน"],
        "dining-restaurants",
    ),
    ...
    (
        ...
        "The Pizza Company",
        "fnb",
        ["Pizza Company", "เดอะพิซซ่าคอมปะนี"],
        "dining-restaurants",
    ),
    (
        "mk-suki",
        ...
        "MK Suki",
        "fnb",
        ["MK Restaurant", "MK", "เอ็มเค", "สุกี้เอ็มเค"],
        "dining-restaurants",
    ),
    (
        "fuji-restaurant",
    ...
    (
        ...
        "Bar-B-Q Plaza",
        "fnb",
        ["BBQ Plaza", "บาร์บีคิวพลาซ่า", "บาร์บีกอน"],
        "dining-restaurants",
    ),
    (
        "sukishi",
        ...
        "Sukishi",
        "fnb",
        ["Sukishi Korean Charcoal Grill", "ซูกิชิ"],
        "dining-restaurants",
    ),
    ...
    (
        ...
        "Jim Thompson",
        "retail",
        ["Jim Thompson Thai Silk", "จิมทอมป์สัน"],
        "shopping",
    ),
